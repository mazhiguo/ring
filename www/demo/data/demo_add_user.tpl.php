...
<? include template('header'); if($add_user_state =='view') { ?>
<form action="demo_add_user.php" method="POST">
<table align="center" cellspacing="1" cellpadding="5">
<tr><th colspan="2">增加用户</th></tr>
<tr><td>帐户(非空唯一不能修改):</td><td><input type="text" name="user_account" value="" /></td></tr>
...
<tr><td colspan="2" align="center"><input type="submit" name="add_user_submit" value="提交"/></td></tr>
</table>
</form>
<? } else { if($code=='') { ?>
<table align="center" cellspacing="1" cellpadding="5">
