...
<? if($send_im_state =='view') { ?>
<form action="demo_send_im.php" method="POST">
<table align="center" cellspacing="1" cellpadding="5">
<tr><th colspan="2">发送IM消息</th></tr>
<tr>
<td width="30%">发送人:</td>
<td align="left">
...
<textarea cols="70" rows="10" name="im_content"></textarea>
</td>
</tr>
<tr><td colspan="2" align="center"><input type="submit" name="send_im_submit" value="提交"/></td></tr>
</table>
</form>
<? } else { if($code=='') { ?>
<table align="center" cellspacing="1" cellpadding="5">
